...
if (isset($_POST['organization_post'])){
    $currentUserName = User::getCurrentUsername();
    if ($_POST['organization_id'] != '' && $_POST['organization_id'] != null){
        $data = [];
        $data['name'] = $_POST['organization_name'];
        if ($_POST['district_id'] != '' && $_POST['district_id'] != null){
            $data['district_id'] = $_POST['district_id'];
        }
        $data['modifiedby'] = $currentUserName;
        DB::update('organization', $data, array('id' => $_POST['organization_id']));
    }
    else{
        $data = [];
        $data['name'] = $_POST['organization_name'];
        ...
        $data['modifiedby'] = $currentUserName;
        $record_id = DB::insert('organization', $data);
    }
    Util::redirect('');
  }
  
if (isset($_POST['organization_delete'])){
    DB::delete('organization', array('id' => $_POST['organization_id']));
    Util::redirect('');
}
?>
<html lang="en">
...
<body style="overflow: auto;">
    ...
    <div class="container">
        ...
        <ul class="list">
            <li><div class="list__name"><strong>ชื่อหน่วยงาน</strong></div><div class="list__action"></div></li>

            <?php
            $organization_list = DB::select('vw_organization_detail', '*', array('ORDER' => array('id')));
            foreach ($organization_list as $organization) { ?>
            <li>
                <div class="list__name"><?php echo $organization['name'] . ' อำเภอ ' . $organization['district_name']; ?></div>
                <div class="list__action">
                    <a href="#editDataModal" class="toggle-modal" data-toggle="modal" data-target="#editDataModal">
                        แก้ไข
                        <input type="hidden" class="modal-param" name="organization_id" value="<?php echo $organization['id']; ?>">
                        <input type="hidden" class="modal-param" name="organization_name" value="<?php echo $organization['name']; ?>">
                        <input type="hidden" class="modal-param" name="district_id" value="<?php echo $organization['district_id']; ?>">
                    </a>
                    <a href="#deleteDataModal" class="toggle-modal" data-toggle="modal" data-target="#deleteDataModal">
                        ลบ
                        <input type="hidden" class="modal-param" name="organization_id" value="<?php echo $organization['id']; ?>">
                        <input type="hidden" class="modal-param" name="organization_name" value="<?php echo $organization['name']; ?>">
                        <input type="hidden" class="modal-param" name="district_name" value="<?php echo $organization['district_name']; ?>">
                    </a>
                </div>
            </li>
            <?php } ?>
            ...
            <div class="action__row d-flex justify-content-center">
                <form action="">
                    <button type="button" class="button toggle-modal" data-toggle="modal" data-target="#editDataModal">
                        ...
                        <input type="hidden" class="modal-param" name="organization_name">
...
<div class="modal fade" id="editDataModal" tabindex="-1" role="dialog" aria-labelledby="editDataModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST">
                <input type="hidden" name="organization_post">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-8 d-flex justify-content-center">
                                <input type="text" name="organization_name" required style="margin: auto; width: 25rem;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4" style="margin: auto;">
                            ...
                            <div class="col-sm-8">
                            <select name="district_id" id="district_id" required style="width: 25rem;">
...
<div class="modal fade" id="deleteDataModal" tabindex="-1" role="dialog" aria-labelledby="deleteDataModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST">
                <input type="hidden" name="organization_delete">
                <input type="hidden" name="organization_id">
                <div class="modal-header">
                ...
                <div class="modal-body d-flex justify-content-center">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="district_name" readonly style="margin: auto; width: 25rem;">
                            </div>
                        </div>
                    </div>
                </div>
